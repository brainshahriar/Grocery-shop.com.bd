...
<div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
	<div class="more-info-tab clearfix ">
	   <h3 class="new-product-title pull-left">New Products</h3>
		<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
			...
			@foreach ($categories as $category)
			@if(session()->get('language')=='bangla') 
			 <li><a data-transition-type="backSlide" href="#smartphone" data-toggle="tab">{{ $category->category_name_bn
			  }}</a></li>
			  @else
			  <li><a data-transition-type="backSlide" href="#smartphone" data-toggle="tab">{{ $category->category_name_en
			}}</a></li>
			@endif
			@endforeach
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('frontend') }}/assets/images/products/p15.jpg" alt=""></a>
			</div><!-- /.image -->			
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{ asset('frontend') }}/assets/images/blank.gif" data-echo="assets/images/products/p7.jpg" alt=""></a>
			</div><!-- /.image -->			
