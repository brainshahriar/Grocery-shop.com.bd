        ...
        <div class="sl-pagebody">
            ...
            <div class="row row-sm">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <label class="ckbox">
                          <input type="checkbox" name="special_offer" value="1" {{ $product->featured==1 ? 'special_offer' : '' }}><span>special_offer</span>
                        </label>
                    </div>

                    <div class="col-md-4">
                        <label class="ckbox">
                          <input type="checkbox" name="special_deals" value="1" {{ $product->featured==1 ? 'special_deals' : '' }}><span>special_deals</span>
                        </label>
                    </div>
